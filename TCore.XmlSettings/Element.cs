...
namespace TCore.XmlSettings
{
    public class Element<T>
    {
        ...
        {
            if (m_createRepeatItemContextDelegate == null)
                throw new InvalidOperationException("Create Repeating Context delegate is null");
        ...
        {
            if (m_commitRepeatItemDelegate == null)
                throw new InvalidOperationException("Commit  Repeating Context delegate is null");
        ...
        {
            if (m_areRemainingItemsDelegate == null)
                throw new InvalidOperationException("AreRemainingRepeatingContext delegate is null");
